...
Sou um desenvolvedor focado em criar aplicações escaláveis e performáticas. Com base sólida em **Frontend (React/Vue)** e graduação em Análise de Sistemas, atualmente estou expandindo minha atuação para o **Backend com Python** no curso Full Stack da EBAC.

Meu objetivo é dominar o ciclo completo de desenvolvimento, desde a arquitetura no banco de dados até o deploy na nuvem.
...
* 🎓 Estudando **Python e Django** (Full Stack EBAC).
* ☁️ Praticando deploy de aplicações serverless na **AWS**.
